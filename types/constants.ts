...
// `gflow character` social promo (9:16). ~18s walkthrough of one-command
// character creation, fanned out one comp id per A/B hook angle.
export const CHARACTER_PROMO_DURATION = 18 * FPS; // 540 frames @ 30fps
