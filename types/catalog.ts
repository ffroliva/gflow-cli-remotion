...
export const catalog: PromoAsset[] = [
  ...
  {
    id: "scene7-beat1-keeper",
    kind: "image",
    location: "https://github.com/ffroliva/gflow-cli-remotion/releases/download/promo-scene7-2026-08-05/beat1-keeper.jpg",
    width: 768,
    height: 1408,
    durationSec: null,
    bytes: 801711,
    sourceComposition: null,
    sourceRunId: "promo-scene7-2026-08-05",
    hookId: null,
    channels: ["linkedin", "reddit", "facebook"],
    addedIso: "2026-08-05",
    description:
      "Beat 1 — the establishing shot. One command, one image, deliberately unremarkable. Real gflow output, captured live 2026-08-05.",
  },
  {
    id: "scene7-beat2-stranger",
    kind: "image",
    location: "https://github.com/ffroliva/gflow-cli-remotion/releases/download/promo-scene7-2026-08-05/beat2-stranger.jpg",
    width: 768,
    height: 1408,
    durationSec: null,
    bytes: 734212,
    ...
    addedIso: "2026-08-05",
    description:
      "Beat 2 — the turn. Same subject in words, NO character binding: a different man in identical wardrobe. Real gflow output, captured live 2026-08-05.",
  },
  {
    id: "scene7-beat3-scene1",
    kind: "image",
    location: "https://github.com/ffroliva/gflow-cli-remotion/releases/download/promo-scene7-2026-08-05/beat3-scene1.jpg",
    width: 768,
    height: 1408,
    durationSec: null,
    bytes: 730387,
    ...
    addedIso: "2026-08-05",
    description:
      "Beat 3 — @Aldous on the pier at night. Character-bound. Real gflow output, captured live 2026-08-05.",
  },
  {
    id: "scene7-beat3-scene2",
    kind: "image",
    location: "https://github.com/ffroliva/gflow-cli-remotion/releases/download/promo-scene7-2026-08-05/beat3-scene2.jpg",
    width: 768,
    height: 1408,
    durationSec: null,
    bytes: 777644,
    ...
    addedIso: "2026-08-05",
    description:
      "Beat 3 — @Aldous in the lamp room at dawn. Character-bound. Real gflow output, captured live 2026-08-05.",
  },
  {
    id: "scene7-beat3-scene3",
    kind: "image",
    location: "https://github.com/ffroliva/gflow-cli-remotion/releases/download/promo-scene7-2026-08-05/beat3-scene3.jpg",
    width: 768,
    height: 1408,
    durationSec: null,
    bytes: 784909,
    ...
    addedIso: "2026-08-05",
    description:
      "Beat 3 — @Aldous on the cliff path in rain. Character-bound. Real gflow output, captured live 2026-08-05.",
  },
  {
    id: "scene7-beat3-scene4",
    kind: "image",
    location: "https://github.com/ffroliva/gflow-cli-remotion/releases/download/promo-scene7-2026-08-05/beat3-scene4.jpg",
    width: 768,
    height: 1408,
    durationSec: null,
    bytes: 708585,
    ...
    addedIso: "2026-08-05",
    description:
      "Beat 3 — @Aldous asleep by the burning lamp. Character-bound. Real gflow output, captured live 2026-08-05.",
  },
];
